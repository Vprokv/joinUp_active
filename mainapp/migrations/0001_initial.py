# Generated by Django 3.2.9 on 2022-02-14 15:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('illustration', models.CharField(blank=True, max_length=256, null=True, verbose_name='Ссылка на иллюстрацию')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, db_index=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_customer', models.IntegerField(null=True, verbose_name='id заказчика')),
                ...
                ('id_employee', models.IntegerField(null=True, verbose_name='Сотрудник создавший запись')),
                ('illustration', models.CharField(blank=True, max_length=256, null=True, verbose_name='Иллюстрация')),
            ],
        ),
        migrations.CreateModel(
            name='Contact',
            fields=[
                ...
                ('illustration_link', models.CharField(blank=True, max_length=256, null=True, verbose_name='Ccсылка на иллюстрацию(аватарку)')),
                ('create_date', models.DateTimeField(verbose_name='Дата создания')),
                ('id_employee', models.IntegerField(verbose_name='Сотрудник создавший запись')),
            ],
        ),
        ...
        migrations.CreateModel(
            name='Block',
            fields=[
                ('adaptationStage', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='mainapp.adaptationstage', verbose_name='Этап')),
                ('json', models.JSONField(null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(verbose_name='Дата создания')),
                ('illustration', models.CharField(blank=True, max_length=256, null=True, verbose_name='Иллюстрация')),
                ('contact', models.ManyToManyField(blank=True, to='mainapp.Contact', verbose_name='Контакты')),
                ('customer', models.ManyToManyField(blank=True, to='mainapp.Customer', verbose_name='Заказчик')),
                ('documents', models.ManyToManyField(blank=True, to='mainapp.Document', verbose_name='Документы')),
                ...
                ('goals', models.ManyToManyField(blank=True, to='mainapp.Goal', verbose_name='Цели')),
                ('levels', models.ManyToManyField(blank=True, to='mainapp.Level', verbose_name='Уровни')),
            ],
        ),
        migrations.CreateModel(
            name='CommentToStage',
